...
async def on_startup(bot: Bot):
    ...
    # Укажи URL твоего Render сервиса
    webhook_url = "https://psych-test-bot-1.onrender.com/webhook"
...
async def main():
    ...
    # Для отладки можно оставить while True, но Render лучше использовать graceful shutdown
